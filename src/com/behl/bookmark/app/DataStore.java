...
import com.behl.bookmark.app.constants.Gender;
...
public class DataStore {
	...
	private static void loadMovies() {
		...
		bookmarks[1][2] = BookmarkManager.getInstance().createMovie(3002, "A Touch of Greatness 2", "", 2004, new String[] {"Albert Cullum"}, new String[] {"Leslie Sullivan"}, MovieGenre.DOCUMENTARIES ,7.3);
